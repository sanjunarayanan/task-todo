...
// generate Auth Token which used for the authentication purpose ..

userSchema.methods.generateAuthToken = async function () {
    const user = this
    const token = jwt.sign({ _id: user._id.toString() }, 'inapptestapi')
...
// login middleware find by credentials ...
